...
export default function Home() {
    ...
    return (
        <div className="bg-blue-400 min-h-198.5">
            <Heading />
            <div className="min-w-screen flex flex-wrap justify-evenly my-7 gap-10">

                <div className="bg-white w-full max-w-md p-4 border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
